...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Admin NB");
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
      super.onOptionsItemSelected(item);
        ...
        if (item.getItemId()==R.id.main_create_gruop_options)
        {
            RequestNewGroup();
    ...
    private void SendUserToSettingActivity()
    {
        ...
        SettingIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
    ...
    private void RequestNewGroup()
    {
        ...
        final EditText gruopNameField = new EditText(MainActivity.this);
        ...
        builder.setPositiveButton("Create", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which)
            {
                ...
                {
                    Toast.makeText(MainActivity.this,"Vui lòng điền tên nhóm của bạn...",Toast.LENGTH_SHORT).show();
                }
                else
                {
    ...
    private void CreateNewGoup(final String groupname)
    {
        RootRef.child("Group").child(groupname).setValue("Admin BNB ")
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        ...
                        {
                            Toast.makeText(MainActivity.this,groupname+ " đã được tạo thành công!!!",Toast.LENGTH_SHORT).show();
                        }
